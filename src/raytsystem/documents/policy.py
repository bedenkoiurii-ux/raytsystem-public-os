...
_HIDDEN_PARTS = frozenset(
    {
        ...
        "__pycache__",
        "_raw",
        # ФОРК uk-locale: «artifacts» звідси ПРИБРАНО. У чужих проєктах це тека
        # збірки, а в нас — `30-Research/Artifacts`, четверта сітка карток
        # (рішення Юрія 2026-07-21: речі та явища культури). Збіг назви робив
        # усі такі картки невидимими в застосунку: 4 з 4 не потрапляли в індекс,
        # хоча в бібліотеці лежали. Теки збірки й так відсіюються через
