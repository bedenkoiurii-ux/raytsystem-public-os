...
**Статуси:** замовлено · картка є · у sources · **відкладено** · закрито.

**«Відкладено»** — пауза за словом Юрія: конвеєр рядок не бере, але реєстр його
пам'ятає. Видалити означало б забути замовлення; відкласти означає чекати слова.
