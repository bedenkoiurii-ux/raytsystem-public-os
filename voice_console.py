...
РІВЕНЬ ДОСТУПУ. Перш ніж переказувати вміст документа, перевір `audience` у frontmatter.
`internal` або поля немає — вміст НЕ переказувати; можна лише сказати, що документ існує.
Мовчання не є дозволом. Тут це важить окремо: вміст виходить із волту на екран телефона,
звідки його легко переслати чи вставити не туди.
