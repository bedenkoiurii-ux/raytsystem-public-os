...
/** Словник назв атласу. Машинний переклад (2 520 назв, локальна модель) лежить
 *  файлом і довантажується окремим чанком; ручний REALM_UK сильніший за нього,
 *  бо ключові назви нашого регіону мають бути точні, а не «приблизно правильні». */
function useRealmNames() {
  return useQuery({
    queryKey: ["map", "realm-names"],
    staleTime: Infinity,
    queryFn: async () => {
      try {
        return (await import("./historical/realm-names.json")).default as Record<string, string>;
      } catch {
        return {} as Record<string, string>;   // словника ще нема — покажемо як є
      }
    }
  });
}
...
const REALM_UK: Record<string, string> = {
  ...
  "Brushed Pottery culture": "Культура штрихованої кераміки",
  "Bulgar Khanate": "Булгарське ханство",
  "Bulgaria": "Болгарія",
  "Burgandy": "Бургундія",
  "Byzantine Empire": "Візантія",
  "Carthaginian Empire": "Карфагенська держава",
  "Castile": "Кастилія",
  "Castilla": "Кастилія",
  "Celtic kingdoms": "Кельтські королівства",
  "Corsica": "Корсика",
  "Crete": "Крит",
  "Crimean Khanate": "Кримське ханство",
  "Croatia": "Хорватія",
  "Cumans": "Половці",
  "Curonians": "Курші",
  "Cyprus": "Кіпр",
  ...
  "Dumonii": "Думнонії",
  "Dutch Republic": "Республіка Сполучених провінцій",
  "Dutchy of Benevento": "Беневентське герцогство",
  ...
  "English territory": "Англійські володіння",
  "Fatimid Caliphate": "Фатімідський халіфат",
  "Finnmark": "Фіннмарк",
  "Finno-Ugric taiga hunter-gatherers": "Фіно-угорські мисливці тайги",
  "Fivizzano": "Фівіццано",
  "France": "Франція",
  "Galicia-Volhynia": "Галицько-Волинське князівство",
  "Genoa": "Генуя",
  "Georgia": "Грузія",
  "Ghaznavid Emirate": "Держава Газневідів",
  "Golden Horde": "Золота Орда",
  "Granada": "Гранада",
  "Grand Duchy of Moscow": "Велике князівство Московське",
  "Greek city-states": "Грецькі поліси",
  "Habsburg Netherlands": "Габсбурзькі Нідерланди",
  "Hafsid Caliphate": "Держава Хафсидів",
  "Holy Roman Empire": "Священна Римська імперія",
  "Hungary": "Угорщина",
  "Icelandic Commonwealth": "Ісландська співдружність",
  "Ilkhanate": "Держава Хулагуїдів",
  "Illyrians": "Іллірійці",
  "Khanate of the Golden Horde": "Золота Орда",
  "Khazar Khaganate": "Хозарський каганат",
  "Khazars": "Хозари",
  "Khiva Khanate": "Хівинське ханство",
  "Kievan Rus": "Київська Русь",
  "Kingdom of France": "Королівство Франція",
  "Kingdom of Georgia": "Грузинське царство",
  "Kingdom of Sardinia": "Сардинське королівство",
  ...
  "Magyars": "Мадяри",
  "Mamluke Sultanate": "Мамлюцький султанат",
  "Massa": "Масса",
  "Milan": "Мілан",
  "Milograd culture": "Милоградська культура",
  "Modena": "Модена",
  "Morocco": "Марокко",
  "Muscovy": "Московія",
  "Naples": "Неаполь",
  ...
  "Norway": "Норвегія",
  "Novgorod": "Новгородська земля",
  "Oldenburg": "Ольденбург",
  "Ottoman Empire": "Османська імперія",
  "Paleo-Siberian hunter-gatherers": "Палеосибірські мисливці-збирачі",
  "Papal States": "Папська держава",
  "Parma": "Парма",
  "Pechenegs": "Печеніги",
  "Persia": "Персія",
  "Plain-Pottery culture": "Культура гладкої кераміки",
  "Poland": "Польща",
  ...
  "Prussia": "Пруссія",
  "Prussians": "Пруси",
  "Quazaq Khanate": "Казахське ханство",
  "Republic of the Seven Zenden": "Республіка Семи Десятин",
  "Rome": "Рим",
  "Rus": "Русь",
  "Russian Empire": "Російська імперія",
  "Ryazan": "Рязанське князівство",
  "Saami": "Саамі",
  "Safavid Empire": "Держава Сефевідів",
  "Sambian-Nothangian culture": "Самбійсько-натангійська культура",
  "Samis": "Саамі",
  "Sardinia": "Сардинія",
  "Sarmates": "Сармати",
  "Scotland": "Шотландія",
  "Scythians": "Скіфи",
  "Seljuk Caliphate": "Сельджуцький султанат",
  "Serbia": "Сербія",
  "Shirvan": "Ширван",
  "Siberians": "Сибірські народи",
  "Sicily": "Сицилія",
  "Spain": "Іспанія",
  "Sweden": "Швеція",
  "Swedes": "Свеї",
  ...
  "Thuringia": "Тюрингія",
  "Trebizond": "Трапезундська імперія",
  "Tsardom of Muscovy": "Московське царство",
  "Tuscany": "Тоскана",
  "Venice": "Венеція",
  "Volga Bulgars": "Волзькі булгари",
  "Western Masurian culture": "Західномазурська культура",
  "White Horde": "Біла Орда",
  "central Asian khanates": "Середньоазійські ханства",
  "Abdelouadides": "Держава Абдальвадідів",
  "Aceh": "Ачех",
  "Ainu": "Айни",
  "Ainus": "Айни",
  "Alwa": "Алва",
  "Amazon hunter-gatherers": "Мисливці-збирачі Амазонії",
  "Andean hunter-gatherers": "Андські мисливці-збирачі",
  "Andean states and chiefdoms": "Андські держави й вождівства",
  "Arawaks": "Аравакі",
  "Athabaskan": "Атабаски",
  "Australian aboriginal hunter-gatherers": "Австралійські аборигени-мисливці",
  "Aymara kingdoms": "Царства аймара",
  "Bantou": "Банту",
  "Benin": "Бенін",
  "Beothuk": "Беотуки",
  "Bornu-Kanem": "Борну-Канем",
  "Caloosahatchee cultureure": "Калусахачі",
  "Caribbean hunter-gatherers": "Карибські мисливці-збирачі",
  "Chagatai Khanate": "Чагатайський улус",
  "Champa": "Тямпа",
  "Chimú Empire": "Держава Чимор",
  "Chola state": "Держава Чола",
  "Desert hunter-gatherers": "Мисливці-збирачі пустель",
  "Dorset": "Дорсетська культура",
  "Eastern North Amercian hunter-gatherers": "Мисливці-збирачі сходу Північної Америки",
  "Ethiopia": "Ефіопія",
  "Expansionist Kingdom of Merina": "Королівство Мерина",
  "Great Khanate": "Велике ханство (Юань)",
  "Great Zimbabwe": "Велике Зімбабве",
  "Guanahatabeyes": "Гуанахатабеї",
  "Guanches": "Гуанчі",
  "Hadramaut": "Хадрамаут",
  "Hainan": "Хайнань",
  "Innu": "Інну",
  "Islamic city-states": "Ісламські міста-держави",
  "Kashmir and Ladakh": "Кашмір і Ладакх",
  "Kediri": "Кедірі",
  ...
  "Mali": "Малі",
  "Maori": "Маорі",
  "Maya city-states": "Міста-держави майя",
  "Merinides": "Держава Маринідів",
  "Mixtec Empire": "Держава міштеків",
  "Muscat": "Маскат",
  "North American Pacifi foraging, hunting and fishing peoples": "Народи тихоокеанського узбережжя Північної Америки",
  "Orissa": "Орісса",
  "Pagan": "Паган",
  "Pampas cultures": "Культури пампасів",
  "Pandya state": "Держава Пандья",
  "Patagonian shellfish and marine mammal hunters": "Патагонські збирачі молюсків і мисливці на морського звіра",
  "Plain bison hunters": "Мисливці на бізонів прерій",
  "Plateau fichers and hunter gatherers": "Рибалки й мисливці плато",
  "Polynesians": "Полінезійці",
  "Savanna hunter-gatherers": "Мисливці-збирачі савани",
  "Shoa": "Шоа",
  "Shogun Japan (Kamakura)": "Японія сьогунату (Камакура)",
  "Shuar": "Шуари",
  "Sinhalese kingdom": "Сингальське королівство",
  "Srivijaya Empire": "Шривіджая",
  "Subarctic forest hunter-gatherers": "Мисливці-збирачі субарктичних лісів",
  "Sukhothai": "Сукхотай",
  "Sultanate of Delhi": "Делійський султанат",
  "Taino": "Таїно",
  "Tasmanian hunter-gatherers": "Тасманійські мисливці-збирачі",
  "Thule": "Туле",
  "Tibet": "Тибет",
  "Touareg": "Туареги",
  "Tuʻi Tonga Empire": "Імперія Туї-Тонга",
  "West African cereal farmers": "Західноафриканські землероби",
  "Yemen": "Ємен",
  "Zapotec Empire": "Держава сапотеків",
  "minor Hindu kingdoms": "Дрібні індуїстські князівства",
  "Đại Việt": "Дайв'єт",
  "Almohad Caliphate": "Держава Альмохадів",
  "Angevin Empire": "Анжуйська імперія",
  "Arctic marine mammal hunters": "Арктичні мисливці на морського звіра",
  "Bagan": "Паган",
  "Berber Tribes": "Берберські племена",
  "Bhutan": "Бутан",
  "Boethuk": "Беотуки",
  "Buwayhid Emirates": "Держава Буїдів",
  "Buyiids": "Буїди",
  "Champa City States": "Міста-держави Тямпи",
  "Comté de Toulouse": "Тулузьке графство",
  "Cuman Khanates": "Половецькі ханства",
  "East Java": "Східна Ява",
  "Ghana": "Гана",
  "Goryeo": "Корьо",
  "Harapunchai": "Харіпунчай",
  "Huari Empire": "Держава Уарі",
  "Ibadites": "Ібадити",
  "Ifat": "Іфат",
  "Imperial Japan (Fujiwara)": "Японія доби Фудзівара",
  "Kamarupa": "Камарупа",
  "Kanem": "Канем",
  "Kara Khitai Khaganate": "Каракитайське ханство",
  "Kwarizm-Shah": "Держава Хорезмшахів",
  "Liao": "Ляо",
  "Malays": "Малайці",
  "Mesoamerican city-states and chiefdoms": "Мезоамериканські міста-держави й вождівства",
  "Mon state": "Держава монів",
  ...
  "Pyu state": "Держава П'ю",
  "Rajput Kingdoms": "Раджпутські князівства",
  "Song Empire": "Імперія Сун",
  "Taiwanese Tribes": "Тайванські племена",
  "Takrur": "Такрур",
  "Tiahuanaco Empire": "Держава Тіауанако",
  "Toltec Empire": "Держава тольтеків",
  "Tuareg Nomadic Tribes": "Туарезькі кочові племена",
  "Tungusic Tribes": "Тунгуські племена",
  "Xixia": "Західне Ся",
  "minor Hindu and Buddhist states": "Дрібні індуїстські та буддійські держави",
};
...
export function MapView({ onOpenDocument }: { onOpenDocument?: (id: string) => void }) {
  ...
  const uk = (name: string) => REALM_UK[name] ?? realmNames.data?.[name] ?? name;
            ...
            {realms.data ? (
              <details className="map-block">
                <summary>
                  ...
                  <span className="cnt">
                    {realm
                      ? <b className="hovered">{uk(realm.name)}</b>
                ...
                <div className="map-realms-list">
                  ...
                  {realms.data.realms
                    .slice()
                    .sort((a, b) => uk(a.name).localeCompare(uk(b.name), "uk-UA"))
                    .map((r) => (
