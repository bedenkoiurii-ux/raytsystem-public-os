...
#
#   ./пульт.sh старт    — підняти (або перепідняти) у фоні
#   ./пульт.sh стоп     — спинити
#   ./пульт.sh стан     — чи живий, останні рядки логу
#   ./пульт.sh лог      — стежити за логом
#
